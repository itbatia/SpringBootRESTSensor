...
Для тестирования этого сервиса написано другое приложение. Это приложение-клиент - __"ClientForSensor"__.   
...
Также для тестирования SpringBootRESTSensor'а можно использовать Postman или Insomnia.
